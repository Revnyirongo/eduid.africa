...
class IdPUserWriter implements Writer
{
    ...
    {
        $samliScope = $this->em->getRepository(\App\Entity\Scope::class)->findOneByValue($idpuser->getIdP()->getHostname());
    ...
    {
        $existingUsers = $this->em->getRepository(\App\Entity\IdPUser::class)->findByEmail($email);
