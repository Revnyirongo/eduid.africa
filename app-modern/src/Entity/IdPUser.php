 ...
 * })
 * @ORM\Entity(repositoryClass="App\Repository\IdPUserRepository")
 * @UniqueEntity(
 *     fields={"username", "IdP"},
...
class IdPUser implements UserInterface, \Serializable
{
     ...
     * @return IdPUser
     */
    public function setIdP(\App\Entity\IdP $idP = null)
    {
        $this->IdP = $idP;
     ...
     * Set Scope.
     *
     * @param \App\Entity\Scope $idP
     *
     * @return IdPUser
     */
    public function setScope(\App\Entity\Scope $scope = null)
    {
        $this->scope = $scope;
    ...
    public function unserialize($serialized)
    {
        ...
        $this->__unserialize(is_array($data) ? $data : []);
    }
