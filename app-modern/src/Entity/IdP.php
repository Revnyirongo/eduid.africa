 ...
 * IdP.
 *
 * @ORM\Entity(repositoryClass="App\Repository\IdPRepository")
 * @ORM\Table(name="idp")
 * @UniqueEntity(
 *     fields={"hostname"},
...
class IdP
{
     ...
     * @var Scope
     *
     * @ORM\OneToOne(targetEntity="App\Entity\Scope")
     ...
     *
     * @param \App\Entity\OrganizationElement $organizationElement
     *
     * @return IdP
     */
    public function addOrganizationElement(\App\Entity\OrganizationElement $organizationElement)
    {
     ...
     * @param \App\Entity\OrganizationElement $organizationElement
     */
    public function removeOrganizationElement(\App\Entity\OrganizationElement $organizationElement)
    {
     ...
     * Add idpAudit.
     *
     * @param \App\Entity\IdPAudit $idpAudit
     *
     * @return IdP
     */
    public function addIdpAudit(\App\Entity\IdPAudit $idpAudit)
    {
     ...
     * @param \App\Entity\IdPAudit $idpAudit
     */
    public function removeIdpAudit(\App\Entity\IdPAudit $idpAudit)
    {
     ...
     * Set defaultScope.
     *
     * @param \App\Entity\Scope $defaultScope
     *
     * @return IdP
     */
    public function setDefaultScope(\App\Entity\Scope $defaultScope = null)
    {
     ...
     * @return IdP
     */
    public function addIdPUser(\App\Entity\IdPUser $idPUser)
    {
     ...
     * @param \App\Entity\IdPUser $idPUser
     */
    public function removeIdPUser(\App\Entity\IdPUser $idPUser)
    {
     ...
     * Add federation.
     *
     * @param \App\Entity\Federation $federation
     *
     * @return IdP
     */
    public function addFederation(\App\Entity\Federation $federation)
    {
     ...
     * @param \App\Entity\Federation $federation
     */
    public function removeFederation(\App\Entity\Federation $federation)
    {
     ...
     * Set entities.
     *
     * @param \App\Entity\Entity $entities
     *
     * @return IdP
     */
    public function setEntities(\App\Entity\Entity $entities = null)
    {
     ...
     * @return IdP
     */
    public function addEntity(\App\Entity\Entity $entity)
    {
     ...
     * @param \App\Entity\Entity $entity
     */
    public function removeEntity(\App\Entity\Entity $entity)
    {
